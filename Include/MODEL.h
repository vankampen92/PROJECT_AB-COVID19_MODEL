...
#define DEPENDENT_PARAMETERS_MAXIMUM 40   /* Maximum number of potentially forced parameters */

#define MODEL_PARAMETERS_MAXIMUM 40       /* Maximum No of MODEL (input) PARAMETERS */

#define MODEL_PARAMETER_SPACE_MAXIMUM 40  /* Maximum Dimension for Parameter Space */

#define No_of_LOCAL_POPULATIONS_MAXIMUM 100

#define MODEL_STATE_VARIABLES_MAXIMUM 4400 /* Model dimension maximum: 44 * 100 coupled ODEs */

#define OUTPUT_VARIABLES_GENUINE 14  /* Number Output Variables (other than MODEL_STATE_VARIABLES)*/
                                     /* See definition_OutPut_Variables.c */

#define OUTPUT_VARIABLES_MAXIMUM 4458       /* MODEL_STATE_VARIABLES_MAXIMUM + 
...
#include "main.H"
#include <assign.h>
#include <Total_Accumulated_Numbers.h>
