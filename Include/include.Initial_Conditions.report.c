...
fprintf(fp, " Susceptible females             ...> -x0   %g\n", nS__0); /*  0 */
fprintf(fp, " Infectious females              ...> -x1   %g\n", nE__0); /*  1 */
fprintf(fp, " Less infectious females         ...> -x2   %g\n", nI1__0); /*  2 */
fprintf(fp, " Last-stage females              ...> -x3   %g\n", nI2__0); /*  3 */
fprintf(fp, " Sexual workers susceptible females     ...> -x4   %g\n", nA__0); /*  4 */
fprintf(fp, " Sexual workers infectious females      ...> -x5   %g\n", nY__0); /*  5 */
fprintf(fp, " Sexual workers less infectious females ...> -x6   %g\n", nR__0); /*  6 */

fprintf(fp, " Sexual workers last-stage females      ...> -x7  %g\n", aI__0); /*  7 */
fprintf(fp, " Sexual workers less infectious females ...> -x8   %g\n", aR__0); /*  6 */
fprintf(fp, " Sexual workers last-stage females      ...> -x9  %g\n", aD__0); /*  7 */
