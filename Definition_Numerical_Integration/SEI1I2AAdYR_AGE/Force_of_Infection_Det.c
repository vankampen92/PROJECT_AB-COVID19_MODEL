...
double Force_of_Infection_Det ( double * y, int age, Parameter_Table * Table )
{
  ...
  */
  ...
  switch(age)
    {
    case 0: 
      Force = (Table->Beta_00 * Table->b / Table->N0 * (Table->Phi * y[n0I1] + y[n0A] + (1.0-Table->Eps_I) * (y[n0I2]+y[n0Ad]) + (1.0-Table->Eps_Y) * y[n0Y] ) +
      ...
      break;
    case 1:
      Force = (Table->Beta_10 * Table->b / Table->N0 * (Table->Phi * y[n0I1] + y[n0A] + (1.0-Table->Eps_I) * (y[n0I2]+y[n0Ad]) + (1.0-Table->Eps_Y) * y[n0Y] ) +
      ...
      break;
    case 2:
      Force = ( Table->Beta_20 * Table->b / Table->N0 * (Table->Phi * y[n0I1] + y[n0A] + (1.0-Table->Eps_I) * (y[n0I2]+y[n0Ad]) + (1.0-Table->Eps_Y) * y[n0Y] ) +
      ...
      break;
    case 3:
      Force = ( Table->Beta_30 * Table->b / Table->N0 * (Table->Phi * y[n0I1] + y[n0A] + (1.0-Table->Eps_I) * (y[n0I2]+y[n0Ad]) + (1.0-Table->Eps_Y) * y[n0Y] ) +
